...
with open('resources_for_animation/LaxWendroff_scheme/2_withoutTime.csv', newline = '') as file:
    reader = csv.reader(file, quoting=csv.QUOTE_NONNUMERIC)
    data = list(reader)

fig, ax = plt.subplots()
t = np.linspace(0, 18.5, 38)
...
ax.set(xlim=[0, 20], ylim=[-1.1, 1.1], xlabel='x', ylabel='u(x,t)', title='Courant number = 1')
...
anima.save(project_directpry_path+'/results/advection_equation/LaxWendroff_2.gif', writer='pillow')
plt.show()