...
TEST(ElementsConverterTest, KeplerianToCartesianToKeplerianWorks) {
    ...
    CartesianElements const transfer = convertKeplerianToCartesian(origin, 3.986e14);
    KeplerianElements const result = convertCartesianToKeplerian(transfer, 3.986e14);
...
TEST(ElementsConverterTest, CartesianToKeplerianToCartesianWorks) {
    ...
    KeplerianElements const transfer = convertCartesianToKeplerian(origin, 3.986e14);
    CartesianElements const result = convertKeplerianToCartesian(transfer, 3.986e14);
