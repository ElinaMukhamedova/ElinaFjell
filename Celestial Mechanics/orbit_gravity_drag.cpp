...
std::filesystem::path projectPath() {
    ...
    auto const pos = filePath.find("orbit_gravity_drag.cpp");
...
int main() {
    ...
    Satellite<EarthGravity, AtmosphericDrag> satelliteRHS{dutContainer, EOPcontainer, gravity, atmosphericDrag, satelliteMass, gravityParameters, atmosphericDragParameters};
    
    auto solution = integrate<RK4Tableau, Satellite<EarthGravity, AtmosphericDrag>>(initialState, beginTime, endTime, 50, satelliteRHS);

    std::ofstream fileRK4(DIR_PATH + "results/" + "gravity_drag" + ".csv");
    fileRK4 << "t,x,y,z,r\n";
